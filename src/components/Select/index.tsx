...
import { TouchableOpacity, View, StyleSheet, Text, Image, ImageStyle } from 'react-native';
...
export default function Select({
	...
	return (
		<View>
			<Modal visible={modalVisible} title={modalTitle} onClose={() => setModalVisible(false)}>
				<ModalContent values={values} onSelect={onHandleSelect} select={select} />
			</Modal>
